...
//	}
    ...
    public ClientTransferView() {
        setTitle("Client - truyền tải file bằng giao thức FTP");
        ...
        textFieldReceive.setBounds(570, 80, 100, 25);
        ...
        btnSendFile = new JButton("STOR");
        btnSendFile.setBounds(10, 360, 80, 25);
        
        btnPasv = new JButton("PASV");
        btnPasv.setBounds(10, 160, 80, 25); //btnPasv btnTypeI btnTypeA btnReceive btnSendFile2 textFieldReceive
        
        btnPort = new JButton("PORT"); //btnPort
        btnPort.setBounds(10, 200, 80, 25);
        
        btnTypeI = new JButton("Type I");
        btnTypeI.setBounds(10, 240, 80, 25); //btnPasv 
        
        btnTypeA = new JButton("Type A");
        btnTypeA.setBounds(10, 280, 80, 25); //btnTypeA 
        
        btnReceive = new JButton("RETR");
        btnReceive.setBounds(10, 320, 80, 25); //btnReceive 
        
        btnSendFile2 = new JButton("Send");
        btnSendFile2.setBounds(497, 50, 80, 25); //btnReceive 
        ...
        btnList.setBounds(10, 400, 80, 25); //btnSendFileA 
